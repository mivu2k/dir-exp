...
<html>
<head>
    <title>Revenue Voucher: {{ $report->voucher_no }}</title>
    <style>
        /* High-Density Print Optimization for Income */
        @page { margin: 1cm; }
        body { font-family: 'Helvetica', sans-serif; color: #111; font-size: 8.5pt; line-height: 1.2; margin: 0; padding: 0; }
        .branding { font-size: 7.5pt; color: #107C10; font-weight: bold; border-bottom: 2pt solid #107C10; padding-bottom: 4pt; margin-bottom: 10pt; text-transform: uppercase; letter-spacing: 1pt; }
        ...
        .status-badge { display: inline-block; padding: 2pt 6pt; border: 1pt solid #107C10; font-size: 7pt; font-weight: bold; text-transform: uppercase; border-radius: 2pt; background: #ebf5eb; color: #107C10; }
        ...
        .line-table th { font-size: 7pt; text-transform: uppercase; color: #107C10; background-color: #f7faf7; font-weight: bold; }
        .line-table td { border-bottom: 0.5pt solid #f0f0f0; }
        
        .summary-box { width: 180pt; margin-left: auto; margin-top: 10pt; border-top: 1.5pt solid #107C10; padding-top: 6pt; }
        .grand-total { font-size: 14pt; font-weight: bold; color: #107C10; text-align: right; letter-spacing: -0.5pt; }
        ...
        .line-table tr:nth-child(even) { background-color: #fcfdfc; }
    </style>
</head>
<body>
    <div class="branding">
        DIR-EXPENSE | Official Revenue Transcript
    </div>

    <table class="voucher-header">
        <tr>
            <td width="65%">
                <div class="meta-label">Revenue Subject</div>
                <div class="meta-value">{{ $report->title }}</div>
                
                <table width="100%">
                    <tr>
                        <td width="50%">
                            <div class="meta-label">Portfolio Owner</div>
            ...
            <td width="35%" style="text-align: right;">
                ...
                <div class="meta-value" style="font-family: monospace; font-size: 13pt; color: #107C10;">{{ $report->voucher_no }}</div>
                
                <div class="meta-label">Audit Status</div>
    ...
    <div style="display: table; width: 100%;">
        <div style="display: table-cell; width: 45%; vertical-align: top; padding-right: 20pt;">
            <div class="section-title">Inflow Analysis</div>
        ...
        <div style="display: table-cell; vertical-align: top;">
            ...
            @else
                <div style="font-size: 7.5pt; font-style: italic; color: #999; padding: 6pt; border: 0.5pt dashed #ddd; text-align: center;">
                    Internal validation pending certification.
                </div>
            @endif
        </div>
    </div>
    ...
    <table class="line-table">
        ...
        <tbody>
            ...
            <tr style="background: #ebf5eb;">
                <td colspan="3" style="text-align: right; font-weight: bold; font-size: 7.5pt; border-top: 1pt solid #107C10;">CUMULATIVE REVENUE</td>
                <td style="text-align: right; font-weight: bold; font-size: 9pt; border-top: 1pt solid #107C10; color: #107C10;">Rs. {{ number_format($report->lines->sum('amount'), 0) }}</td>
            </tr>
        </tbody>
    </table>

    <div class="footer">
        Generated: {{ date('d M Y H:i') }} | Financial Reference v4.2 | Page [1]
    </div>
</body>
</html>
